...
export default function Tips(){
    ...
    function pedido(){
        ...
        .then(json=> {
            console.log(frase)
            return setFrase(json)
        })
    }


    return(<div className={styles.tipCont}>
        <div id={styles.id}>
            Tip #{frase.slip && frase.slip.id}
        </div>
        <div className={styles.tip}>
            "{frase.slip ? frase.slip.advice:"Press for generate a new tip"}"
        ...
        <div className={styles.boton}>
            <button id={styles.boton} onClick={pedido}>
